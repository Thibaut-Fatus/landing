...
(function($) {
    ...
    **/
    var launch = new Date(2016, 04, 16, 12, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('Notre site sera bientôt disponible...');
        }
        else{
            ...
            message.html('Notre site est en construction, mais il sera bientôt en ligne !');
        }
    }
})(jQuery);
/******************************************************************************************************************************
